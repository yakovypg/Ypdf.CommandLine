...
internal sealed class ConfigSubcommand
{
    ...
    [ValueOption<string>(
        ...
        valueRestriction: "!nullOrWhiteSpace" +
            "\n?pthon alias must not be an empty string or a string consisting only of whitespace characters")
    ]
    ...
    [ValueOption<string>(
        ...
        valueRestriction: "!nullOrWhiteSpace" +
            "\n?virtual environment path must not be an empty string or a string consisting only of whitespace characters")
    ]
